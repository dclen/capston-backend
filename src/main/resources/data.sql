...
VALUES (1, 'Mrs', 'Bronagh', 'Doherty', '0123456789', '123 Main Street', 'Main Road', 'Magherafelt', 'BT45 5GW', 'Coupe', '1600','2', true, true, 50000, '2010-11-09'),
       ...
       (3, 'Mr', 'Conor', 'Hawkins', '0123456789', '125 Main Street', 'Main Road', 'Belfast', 'BT8 5GW', 'Hatchback', '1400','4', false, true, 10000, '2002-10-08'),
       (4, 'Mr', 'Alex', 'ONeill', '0123456789', '126 Main Street', 'Main Road', 'Armagh', 'BT61 5GW', 'Estate', '2000','1', false, false, 35000, '2008-12-05');
